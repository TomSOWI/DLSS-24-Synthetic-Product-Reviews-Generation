...
## Data
In the folder [Data](https://github.com/TomSOWI/DLSS-24-Synthetic-Product-Reviews-Generation/tree/main/Data) :bar_chart:, we have made available our main datasets. The remaining datasets (from the ETL Notebook) are available [here](https://drive.google.com/drive/folders/1lyoWJOrpqgbwbKCJZ5gol5xAFHcVZ1ap?usp=sharing). 
Below you will find a brief overview of all the data files:
